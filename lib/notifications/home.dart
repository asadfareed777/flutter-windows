...
class _MyAppState extends State<MyNotificationApp> {
  @override
...
class _HomeNotificationPageState extends State<HomeNotificationPage> with TrayListener {
